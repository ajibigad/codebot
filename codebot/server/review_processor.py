...
class ReviewProcessor:
    ...
    def process_comment(self, comment_data: dict):
        ...
        is_change_request = classification["type"] == "change_request"
...
3. AMBIGUOUS - The intent is unclear and needs clarification from the reviewer
   Examples: "This could be better", "Not sure about this", "Hmm..."

Respond ONLY with valid JSON in this exact format:
{{
  "type": "query" | "change_request" | "ambiguous",
...
IMPORTANT: Write the "Changes Made" section as a unified description of the complete implementation. Do NOT list individual commits or updates. Describe the feature as it exists now."""
            ...
            if result.returncode == 0 and result.stdout.strip():
                ...
                if "## 📋 Task Description" in new_body:
                    self.github_pr.update_pr_description(owner, repo, pr_number, pr_title, new_body)
